    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="阅读资料名称" prop="ziliaoName">
                       <el-input v-model="ruleForm.ziliaoName"
                                 placeholder="阅读资料名称" clearable  :readonly="ro.ziliaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ziliaoPhoto" label="封面" prop="ziliaoPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.ziliaoPhoto?ruleForm.ziliaoPhoto:''"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ziliaoFile" label="文件" prop="ziliaoFile">
                        <file-upload
                                tip="点击上传文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.ziliaoFile?ruleForm.ziliaoFile:''"
                                @change="ziliaoFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.ziliaoFile" label="文件" prop="ziliaoFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.ziliaoFile"  >文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="ziliaoClickNumber">
                       <el-input v-model="ruleForm.ziliaoClickNumber"
                                 placeholder="点击次数" clearable  :readonly="ro.ziliaoClickNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.ziliaoYesnoTypes" label="审核状态" prop="ziliaoYesnoTypes">
                        <el-input v-model="ruleForm.ziliaoYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.ziliaoYesnoText" label="审核结果" prop="ziliaoYesnoText">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ziliaoName: [
                              { required: true, message: '阅读资料名称不能为空', trigger: 'blur' },
                          ],
                   ziliaoTypes: [
