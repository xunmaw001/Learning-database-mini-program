        ...
        <form class="app-update-pv">
            <view
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#4477C5","textAlign":"left"}'
                          class="title">资料类型</view>
                    <picker @change="ziliaoTypesChange" :value="ziliaoTypesIndex" :range="ziliaoTypesOptions" range-key="indexName">
                        <view
                                :style='{"boxShadow":"0 0 16rpx #07588D inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#4477C5","borderRadius":"20rpx","color":"#4477C5","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                ...
                <view
                    ...
                    <input   disabled
                             :style='{"boxShadow":"0 0 16rpx #07588D inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#4477C5","borderRadius":"20rpx","color":"#4477C5","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.ziliaoClickNumber" type="number" v-model="ruleForm.ziliaoClickNumber" placeholder="点击次数"></input>
                </view>
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#4477C5","textAlign":"left"}'
                          class="title">审核状态</view>
                    <picker @change="ziliaoYesnoTypesChange" :value="ziliaoYesnoTypesIndex" :range="ziliaoYesnoTypesOptions" range-key="indexName">
                        <view
                                :style='{"boxShadow":"0 0 16rpx #07588D inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#4477C5","borderRadius":"20rpx","color":"#4477C5","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.ziliaoYesnoTypes?ruleForm.ziliaoYesnoValue:"请选择审核状态"}}</view>
                    </picker>
                </view>
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 16rpx #07588D inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#4477C5","borderRadius":"20rpx","color":"#4477C5","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.ziliaoYesnoText" v-model="ruleForm.ziliaoYesnoText" placeholder="审核结果"/>
            </view>
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.ziliaoClickNumber) && (!this.$validate.isIntNumer(this.ruleForm.ziliaoClickNumber)) && this.ruleForm.ziliaoClickNumber >0) {
                    this.$utils.msg(`点击次数不能为空，不能小于0 格式为数字`);
                    return
                }
				if ((!this.ruleForm.ziliaoYesnoTypes)) {
                    this.$utils.msg(`审核状态不能为空`);
                    return
                }
				if ((!this.ruleForm.ziliaoYesnoText)) {
                    this.$utils.msg(`审核结果不能为空`);
                    return
                }
                if (this.ruleForm.id) {
