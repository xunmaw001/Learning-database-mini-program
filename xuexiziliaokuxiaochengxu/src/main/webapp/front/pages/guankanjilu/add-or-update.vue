    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`guankanjilu`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.guankanjiluId){
                this.ruleForm.guankanjiluId = options.guankanjiluId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
                if (this.ruleForm.id) {
                    await this.$api.update(`guankanjilu`, this.ruleForm);
                } else {
                    await this.$api.save(`guankanjilu`, this.ruleForm);
                }
